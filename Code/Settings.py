...
def create_animation(spritesheet,animation_length,width,height,index_x,index_y,size):
    animation_list=[]
    steps=index_x
...
Useful_Item_sprites=pygame.image.load("Sprites/coins-chests-etc-2-0.png").convert_alpha()
Weapons_sprites=pygame.image.load("Sprites/Medieval weapons pack v1.2/Medieval weapons pack/steel/outline x4.png").convert_alpha()
